      ...
      <div className="container mx-auto text-white py-12 px-5 md:px-0">
        ...
        <div className="flex justify-around gap-5">
          <div className="flex flex-col justify-center items-center gap-3">
            <Image src="/help.png" alt="help" width={88} height={88} />
          ...
          <div className="flex flex-col justify-center items-center gap-3">
            <Image src="/contribute.png" alt="contribute" width={88} height={88} />
          ...
          <div className="flex flex-col justify-center items-center gap-3">
            <Image src="/collaborate.png" alt="collaborate" width={88} height={88} />
