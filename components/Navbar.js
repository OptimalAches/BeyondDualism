            ...
            <div className='relative flex flex-col gap-4 md:block'>
                {session && <>
                    <button
                        ...
                        className="text-white bg-blue-950 hover:bg-blue-900 hover:ring-2 hover:ring-purple-500 mx-4 focus:ring-4 focus:outline-none focus:ring-purple-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center transition-all duration-200 shadow-lg border border-purple-600"
                        type="button">
                ...
                {!session && (
                    <Link href={"/login"}>
                        <button type="button" className="text-white bg-blue-950 hover:bg-blue-900 hover:ring-2 hover:ring-purple-500 focus:ring-4 focus:outline-none focus:ring-purple-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 transition-all duration-200 shadow-lg border border-purple-600">
                            Log in
                        </button>
                    </Link>
                )}
