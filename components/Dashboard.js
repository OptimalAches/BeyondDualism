    ...
    <>
      ...
      <div className='dashboard container mx-auto py-5'>
        ...
        <form className="entries flex flex-col gap-2 items-center" action={handleSubmit}>
          ...
          <div className="profilepic w-2/3">
          ...
          <div className="razorpayid w-2/3">
          ...
          <div className="razorpaysecret w-2/3">
          ...
          <button type="submit" className="w-2/3 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded-lg text-xs p-2 text-center mt-7">Save</button>
